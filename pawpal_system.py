...
class Task:
    ...
    def next_occurrence(self) -> Optional[Task]:
        """Return a new pending Task for the next occurrence, or None if once."""
...
class Scheduler:
    ...
    def detect_conflicts(self) -> list[str]:
        """Warn when two tasks for the same pet are booked at the same minute."""
